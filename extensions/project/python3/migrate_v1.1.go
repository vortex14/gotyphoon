...
//go:embed builders/v1.1
var buildersV11 embed.FS

type ProjectMigrateV11 struct {
	//Project interfaces2.Project
	//Dir     *interfaces2.FileObject
}

func (m *ProjectMigrateV11) MigrateV11() {
	//	m.migrateComponents()
	//	m.CreateDockerComposeConfigs()
	//	u := utils2.Utils{}
	//
	//	dir, err := fs.Sub(buildersV11, "v1.1")
	//	if err != nil {
	//		panic(err)
	//	}
	//
	//	_, dataT := u.GetGoTemplate(&interfaces2.FileObject{Path: m.Dir.Path, Name: "component.gopy"}, dir)
	//
	//	_, confT := u.GetGoTemplate(&interfaces2.FileObject{Path: m.Dir.Path, Name: "config.goyaml"}, dir)
	//	goTemplate := interfaces2.GoTemplate{
	//		Source:     confT,
	...
	//			"apiClass":       "FetcherApi",
	//		}
	//		goTemplateFetcher := interfaces2.GoTemplate{
	//			Source:     dataT,
	...
	//		}
	//
	//		goTemplateProcessor := interfaces2.GoTemplate{
	//			Source:     dataT,
	...
	//		}
	//
	//		goTemplateDonor := interfaces2.GoTemplate{
	//			Source:     dataT,
	//			ExportPath: "donor.py",
	//			Data:       donorConfig,
	//		}
	...
	//		}
	//		goTemplateScheduler := interfaces2.GoTemplate{
	//			Source:     dataT,
	...
	//		}
	//
	//		goTemplateTransporter := interfaces2.GoTemplate{
	//			Source:     dataT,
	...
	//}
	//
	//func (m *ProjectMigrateV11) CreateDockerComposeConfigs() {
	//	u := utils2.Utils{}
	//
	//	dir, err := fs.Sub(buildersV11, "v1.1")
	//	if err != nil {
	...
	//	}
	//
	//	_, dataTDockerLocal := u.GetGoTemplate(&interfaces2.FileObject{Path: m.Dir.Path, Name: "docker-compose.local.goyaml"}, dir)
	//
	...
	//	}
	//
	//	goTemplateComposeLocal := interfaces2.GoTemplate{
...
func (m *ProjectMigrateV11) migrateComponents() {
...
func (m *ProjectMigrateV11) VisitAndReplace(path string, fi os.FileInfo, err error) error {
...
func (m *ProjectMigrateV11) CreateTransporterManifest() {
