...
func (a *Action) InitPipelineGraph(logger interfaces.LoggerInterface)  {
	//a.Pipeline.SetGraph(logger, a.Graph)
	//a.Pipeline.InitGraph()
...
//action.InitPipelineGraph(r.LOG)
//action.SetGraphNodes(r.graph.GetNodes())
//action.GetPipeline().SetGraphNodes(r.graph.GetNodes())
//action.GetPipeline().InitGraph()
//r.LOG.Error(action.GetName(), " ",action.GetPath(), action.GetPipeline().GetName(),">>> ",r.graph.GetNodes() )
//action.InitPipelineGraph(r.LOG)
//action.GetPipeline().SetGraphNodes(r.GetGraphNodes())
//}
//action.SetGraphNodes(r.subGraph.GetNodes())
