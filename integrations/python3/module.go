...
//
//	if !(function != nil && Python3.PyCallable_Check(function)) { //retval: Borrowed
...
//	}
//
//	oImport := Python3.PyImport_ImportModule(m.Path) //ret val: new ref
...
//	}
//
//	oModule := Python3.PyImport_AddModule(m.Path) //ret val: borrowed ref (from oImport)
//
...
//	}
//
//	oDict := Python3.PyModule_GetDict(oModule) //retval: Borrowed
